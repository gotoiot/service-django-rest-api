...
class OptionSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Option
        fields = ('id', 'title', 'text', 'is_correct', 'option_type')
...
class QuestionSerializer(serializers.HyperlinkedModelSerializer):
    ...
    assesment = AssesmentSerializer()
    option_set = OptionSerializer(many=True, fields=('id', 'title', 'text', 'option_type'))

    class Meta:
        model = Question
        fields = ('id', 'title', 'description', 'category', 'question_type', 'assesment', 'option_set')